...
trainCascadeObjectDetector('Rats_LBP.xml', positiveInstances, 'Negative_Folder', 'FalseAlarmRate',0.2,'TruePositiveRate', 0.995); %,'NumCascadeStages', 20

%Create Object
ratDetector = vision.CascadeObjectDetector('Rats_LBP.xml');

% %Read Image
% I = imread('Image_12751.jpg');
% 
% %Detect Faces
% bboxes = step(ratDetector, I);
% 
% %Annotate and display figure
% IRats = insertObjectAnnotation(I, 'rectangle', bboxes, 'Rat');
% figure, imshow(IRats), title('Detected Rat');
