...
% Train Detector
trainCascadeObjectDetector('Rats_HOG.xml', positiveInstances, 'Negative_Folder', 'FalseAlarmRate',0.2,'TruePositiveRate', 0.995); %,'NumCascadeStages', 20

%Create Object
ratDetector = vision.CascadeObjectDetector('Rats_HOG.xml');

%Load video
cd '/Users/ChrisPenny/Documents/MATLAB/Nicolelis Analysis/Cascade Model Generator V2/Zero Maze Videos';
videoFReader = vision.VideoFileReader('Video_12.mp4', 'VideoOutputDataType', 'uint8');
